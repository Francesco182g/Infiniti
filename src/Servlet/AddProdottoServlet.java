...
public class AddProdottoServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*
		 * MODIFICA: Aggiunta del codice per la gestione dell'offerta
		 */
		...
		try {
			if(u == null) {
				...
				request.getRequestDispatcher("InvitoLogReg.jsp").forward(request, response);
					...
					DatabaseQuery.addProdotto(prodotto, u.getEmail());
					System.out.println("Prodotto aggiunto da: " + u.getEmail());
