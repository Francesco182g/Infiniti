...
public class DatabaseQuery {
	 ...
	 */
	static {
		queryAddUtente = "INSERT INTO infiniti.user (email, Nome, Cognome, Password, Sesso, Foto) VALUES (?,?,?,?,?,?);";
		queryEliminaUtente = "DELETE FROM infiniti.user WHERE email = ?";
		queryGetUtente = "SELECT * FROM infiniti.user WHERE email=?";
		queryAddProdotto = "INSERT INTO infiniti.prodotto (idProdotto, Descrizione, Quantità, PrezzoSingolo, Tipo, Condizione, Nome, idUtente, Path) VALUES (?,?,?,?,?,?,?,?,?);";
		queryEliminaProdotto = "DELETE FROM infiniti.prodotto WHERE idProdotto = ?";
		queryGetProdotti = "SELECT * FROM infiniti.prodotto";
		queryGetMieiOrdini = "SELECT * FROM infiniti.ordine WHERE idUtente = ?";
		queryCercaProdotto = "SELECT * FROM infiniti.prodotto WHERE Nome = ?";
		queryGetProdottoById ="SELECT * FROM infiniti.prodotto WHERE idProdotto = ?";
		queryGetProdottoByUser ="SELECT * FROM infiniti.prodotto WHERE idUtente = ?";
		queryAddCarrello = "INSERT INTO infiniti.carrello (idUtente, idProdotto) VALUES (?, ?)";
		queryAddOrdine = "INSERT INTO infiniti.ordine (idOrdine, idProdotto, idUtente, Data, Pagamento, Indirizzo, Note, Prezzo) VALUES (?,?,?,?,?,?,?,?)";
		queryGetCarrello = "SELECT * FROM infiniti.carrello WHERE idUtente = ?";
		queryEliminaCarrello = "DELETE FROM infiniti.carrello WHERE idUtente = ?";
		queryEliminaProdottoCarrello = "DELETE FROM infiniti.prodotto WHERE idProdotto = ?";
		queryGetNumeroProdotto = "SELECT * FROM infiniti.carrello WHERE idUtente = ?";
		queryGetUtenti = "SELECT * FROM infiniti.user";
		queryGetAdmin = "SELECT * FROM infiniti.admin WHERE idadmin = ?";
	}
